...
execute if data storage snbt:temp {char:"{"} run return run function snbt:get_object
execute if data storage snbt:temp {char:"["} run return run function snbt:get_list
