...
execute if score escape snbt matches 5 run function snbt:prepend_backslash with storage snbt:temp context
...
function snbt:parse_key_double with storage snbt:temp context
